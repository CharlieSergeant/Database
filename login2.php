<html>
  <br><a href='Clogout.php'>User logout</a>
...
<br><a href='updatetransaction.php'>Display and update transaction</a>

<form action="search.php" method="get">
<br>Keyword:<input type="text" name="search"  required="required" >
